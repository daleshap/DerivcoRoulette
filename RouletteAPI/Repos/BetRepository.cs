...
namespace RouletteAPI.Repos
{
    public class BetRepository : IBetRepository
    {
        ...
        public async Task<DataTable> GetBetsForSpinAsync(int spinIdNumber)
        {
        ...
        public async Task<DataTable> GetAllBetsAsync()
        {
        ...
        public async Task<DataTable> GetSingleBetAsync(int betId)
        {
